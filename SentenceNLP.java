...
public class SentenceNLP {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String str1 = "The chief executive said that the company’s profit was going down last year.";
            String str2 = "president said the revenue was good last year.";
            List<String> hashset = new ArrayList<String>();
            hashset.add(str1);
            hashset.add(str2);
            HashSet set = new HashSet(hashset);

            SentenceNLP b = new SentenceNLP(set);
            b.train();

            System.out.println("\nBigram with out smothing Probabilites " + b.unsmoothedProbability(str1, str2));
            System.out.println("\nBigram add one smothing Probabilites " + b.addOneSmoothedProbability(str1, str2));
            System.out.println("\nBigram Good Turing smothing Probabilites " + b.goodTuringSmoothedProbability(str1, str2));
            System.out.println("\n Total Probabilites of sentences : " + b.perplexity(set));

            System.out.println("\n Get highest probable  Sentence  : " + str2);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }

    public SentenceNLP(Set<String> samples) {
    ...
    public void train() {
        ...
        for (String sample : samples) {
            ...
            while (matcher.find()) {
                ...
                //System.out.println(" count OnCorpus  " + unigramCount + "    " + count + "    " + innerCounts);
                System.out.println("Bigram:  " + previousWord);
                System.out.println("Uniram Count " + unigramCount);
                System.out.println("Bigram count,  Good Turing smotting " + numTrainingBigrams);
                System.out.println("Bigram Probabilitys " + count+"\n");
            }
    ...
    public double perplexity(Set<String> testSamples) {
        ...
        //System.out.println("Bigram count onCorpus Good Turing somthing " + goodword);
